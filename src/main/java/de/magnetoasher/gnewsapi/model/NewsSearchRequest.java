package de.magnetoasher.gnewsapi.model;

import io.swagger.v3.oas.annotations.media.Schema;

@Schema(
        description = "Represent the request object when searching for news"
)
public class NewsSearchRequest {
    ...
    @Schema(
            description = "This parameter allows you to choose in which " +
    ...
    public NewsSearchRequest(String category, String country, String language, int max, String keywords, String in) {
